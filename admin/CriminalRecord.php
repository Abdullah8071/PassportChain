...
<head>
    ...
    <title>Admin | CriminalRecord</title>
							...
							<div class="module">
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Case Number</label>
											<div class="controls">
												<input type="text" name="casenumber" placeholder="Enter Case Number" class="span8 tip" required>
											</div>
                                        </div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Registered By</label>
											<div class="controls">
												<input type="text" name="registeredby" placeholder="Enter Registered By" class="span8 tip" required>
											</div>
                                        </div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="date" placeholder="Enter Date" class="span8 tip" required>
											</div>
                                        </div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Decision</label>
											<div class="controls">
												<input type="text" name="decision" placeholder="Enter Decision" class="span8 tip" required>
											</div>
                                        </div>
