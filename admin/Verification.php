								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="fathername" placeholder="Enter Father Name" class="span8 tip" required>
											</div>
                                        </div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="nationality" placeholder="Enter Nationality" class="span8 tip" required>
											</div>
                                        </div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Date Issue</label>
											<div class="controls">
												<input type="text" name="dateissue" placeholder="Enter Date Issue" class="span8 tip" required>
											</div>
                                        </div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Date Expiry</label>
											<div class="controls">
												<input type="text" name="dateexpiry" placeholder="Enter Expiry Date" class="span8 tip" required>
											</div>
                                        </div>
