...
if($num>0)
{
$extra="VerificationHome.php";//
$_SESSION['vlogin']=$_POST['username'];
$_SESSION['id']=$num['id'];
...
<head>
	...
	<title>Passport Chain | Admin login</title>
...
<body>
	...
	<div class="wrapper">
		<div class="container">
		<center><h2>Verification Portal</h2></center>
			<div class="row">
